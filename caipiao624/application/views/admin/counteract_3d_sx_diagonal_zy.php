        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="9">生肖名 - 左右斜对角线生克行轨迹对应</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->num3)) ? get_sx_counteract( get_sx_ganzhi_wuxing(get_shengxiaoma($rs->sx_year,$rs->num1)), get_sx_ganzhi_wuxing(get_shengxiaoma($rs->sx_year,$rs->num3)) ):'';?></td>
