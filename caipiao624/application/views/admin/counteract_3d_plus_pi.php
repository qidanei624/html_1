                ...
                <table class="typecho-list-table">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td style="text-align:center"><?php echo (isset($rs->num1)) ? '+':'';?></td>
							<td><?php echo (isset($rs->num1)) ? get_weishu_pm($pi[$k], $rs->num1,$status) : '';?></td>
							<td style="text-align:center"><?php echo (isset($rs->num2)) ? '+':'';?></td>
							<td><?php echo (isset($rs->num2)) ? get_weishu_pm($pi[$k], $rs->num2,$status) : '';?></td>
							<td style="text-align:center"><?php echo (isset($rs->num3)) ? '+':'';?></td>
