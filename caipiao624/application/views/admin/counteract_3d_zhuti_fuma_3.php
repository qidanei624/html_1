                ...
                <table class="typecho-list-table">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->zhuti_fuma)) ? $rs->zhuti_fuma : '';?></td>

							<td style="text-align:center;"><?php echo get_zf_check2(isset($rs->lottery_number_2) ? $rs->lottery_number_2 : '', $rs->lottery_number[0]);?></td>
							<td style="text-align:center;"><?php echo get_zf_check2(isset($rs->lottery_number_2) ? $rs->lottery_number_2 : '', $rs->lottery_number[1]);?></td>
							<td style="text-align:center;"><?php echo get_zf_check2(isset($rs->lottery_number_2) ? $rs->lottery_number_2 : '', $rs->lottery_number[2]);?></td>
