        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="15">等距绝对值系统 - 位号左右斜轨迹对应</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->num2)) ? '减' : '';?></td>
							<td><?php echo (isset($rs->num2)) ? get_weishu_pm($rs->num1, $rs->num2,$status) : '';?></td>
							<td></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3:'';?></td>
							<td><?php echo (isset($rs->num3)) ? '减' : '';?></td>
							<td><?php echo (isset($rs->num3) && isset($rs->num4)) ? get_weishu_pm($rs->num3, $rs->num4,$status) : '';?></td>
							<td></td>
							<td><?php echo (isset($rs->num5)) ? $rs->num5:'';?></td>
							<td><?php echo (isset($rs->num5)) ? '减' : '';?></td>
							<td><?php echo (isset($rs->num5) && isset($rs->num6)) ? get_weishu_pm($rs->num5, $rs->num6, $status):'';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
                        <tr class="even">
