        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="15">生肖名 - 同顺序对角线轨迹对应</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
							<th>年度期号</th>
							<th>纳音</th>
                            <th colspan="5">A 标准</th>
							<th></th>
							<th colspan="5">B 标准</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->num1) && isset($rs->num2)) ? get_sx_order_diagonal_arrow(get_shengxiaoma($rs->sx_year,$rs->num1), get_shengxiaoma($rs->sx_year,$rs->num2), 'A') : '';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2.' '.get_shengxiaoma($rs->sx_year,$rs->num2) : '';?></td>
							<td><?php echo (isset($rs->num2) && isset($rs->num3)) ? get_sx_order_diagonal_arrow(get_shengxiaoma($rs->sx_year,$rs->num2), get_shengxiaoma($rs->sx_year,$rs->num3), 'A') : '';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3.' '.get_shengxiaoma($rs->sx_year,$rs->num3) : '';?></td>
							<td></td>
							<td><?php echo (isset($rs->num1)) ? $rs->num1.' '.get_shengxiaoma($rs->sx_year,$rs->num1) : '';?></td>
							<td><?php echo (isset($rs->num1) && isset($rs->num2)) ? get_sx_order_diagonal_arrow(get_shengxiaoma($rs->sx_year,$rs->num1), get_shengxiaoma($rs->sx_year,$rs->num2), 'B') : '';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2.' '.get_shengxiaoma($rs->sx_year,$rs->num2) : '';?></td>
							<td><?php echo (isset($rs->num2) && isset($rs->num3)) ? get_sx_order_diagonal_arrow(get_shengxiaoma($rs->sx_year,$rs->num2), get_shengxiaoma($rs->sx_year,$rs->num3), 'B') : '';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3.' '.get_shengxiaoma($rs->sx_year,$rs->num3) : '';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
                        <tr class="even">
                        	<td colspan="9"><h6 class="typecho-list-table-title">没有任何数据</h6></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
