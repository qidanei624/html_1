        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="27">位置号码 - 左右斜生克行轨迹对应和纯杂主题配搭轨迹对应</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->num2)) ? get_prefix_nums($rs->num1, $rs->num2):'';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td style="background-color:#528B8B;"></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>
							<td><?php echo (isset($rs->num3) && isset($rs->num4)) ? get_prefix_nums($rs->num3, $rs->num4):'';?></td>
							<td><?php echo (isset($rs->num4)) ? $rs->num4 : '';?></td>
							<td style="background-color:#528B8B;"></td>
							<td><?php echo (isset($rs->num5)) ? $rs->num5 : '';?></td>
							<td><?php echo (isset($rs->num5) && isset($rs->num6)) ? get_prefix_nums($rs->num5, $rs->num6):'';?></td>
							<td><?php echo (isset($rs->num6)) ? $rs->num6 : '';?></td>
							<td style="background-color:#D3DBB3;"></td>

							<td><?php echo (isset($rs->num1)) ? $rs->num1 : '';?></td>
							<td><?php echo (isset($rs->num1) && isset($rs->num2)) ? get_numeric_cz($rs->num1, $rs->num2):'';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td style="background-color:#528B8B;"></td>

							<td style="text-align:center"><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>
							<td><?php echo (isset($rs->num3) && isset($rs->num4)) ? get_numeric_cz($rs->num3, $rs->num4):'';?></td>
							<td><?php echo (isset($rs->num4)) ? $rs->num4 : '';?></td>
							<td style="background-color:#528B8B;"></td>
							<td><?php echo (isset($rs->num5)) ? $rs->num5 : '';?></td>
							<td><?php echo (isset($rs->num5) && isset($rs->num6)) ? get_numeric_cz($rs->num5, $rs->num6):'';?></td>
							<td><?php echo (isset($rs->num6)) ? $rs->num6 : '';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
