                ...
                <table class="typecho-list-table">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->num1)) ? get_weishu_pm($rs->pid, $rs->num1,$status) : '';?></td>
							<td style="text-align:center"><?php echo (isset($rs->num2)) ? '乘':'';?></td>
							<td><?php echo (isset($rs->num2)) ? get_weishu_pm($rs->pid, $rs->num2,$status) : '';?></td>
							<td style="text-align:center"><?php echo (isset($rs->num3)) ? '乘':'';?></td>
							<td><?php echo (isset($rs->num3)) ? get_weishu_pm($rs->pid, $rs->num3,$status) : '';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
                        <tr class="even">
