        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="15">位置号码 - 左右斜对角线生克行轨迹对应</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
							<th>年度期号</th>
							<th>纳音</th>
                            <th colspan="5">生克行轨迹对应</th>
							<th></th>
                            <th colspan="5">纯杂主题配搭轨迹对应</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->num3)) ? get_prefix_nums($rs->num1, $rs->num3):'';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>
							<td></td>
							<td style="text-align:center"><?php echo (isset($rs->num1)) ? $rs->num1 : '';?></td>
							<td><?php echo (isset($rs->num2)) ? get_numeric_cz($rs->num1, $rs->num2):'';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td><?php echo (isset($rs->num3)) ? get_numeric_cz($rs->num1, $rs->num3):'';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
