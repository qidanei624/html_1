                ...
                <table class="typecho-list-table">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2==0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->jgx)) ? get_jgx_counteract($rs->jgx, (in_array(0, $xu_shuxing)) ? 0 : '') : '';?></td>
							<td><?php echo (in_array(0, $xu_shuxing)) ? 'ⓧ0' : '';?></td>
							<td><?php echo (isset($rs->jgx)) ? get_jgx_counteract($rs->jgx, (in_array(1, $xu_shuxing)) ? 1 : '') : '';?></td>
							<td><?php echo (in_array(1, $xu_shuxing)) ? 'ⓧ1' : '';?></td>
							<td><?php echo (isset($rs->jgx)) ? get_jgx_counteract($rs->jgx, (in_array(2, $xu_shuxing)) ? 2 : '') : '';?></td>
							<td><?php echo (in_array(2, $xu_shuxing)) ? 'ⓧ2' : '';?></td>
							<td><?php echo (isset($rs->jgx)) ? get_jgx_counteract($rs->jgx, (in_array(3, $xu_shuxing)) ? 3 : '') : '';?></td>
							<td><?php echo (in_array(3, $xu_shuxing)) ? 'ⓧ3' : '';?></td>
							<td><?php echo (isset($rs->jgx)) ? get_jgx_counteract($rs->jgx, (in_array(4, $xu_shuxing)) ? 4 : '') : '';?></td>
