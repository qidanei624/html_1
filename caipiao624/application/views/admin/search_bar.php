...
<form method="get">
	<p class="operate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EXCEL: &nbsp;
		<span class="operate-button"><?php echo anchor("admin/counteract/manage/$status/excel_write?".$_SERVER['QUERY_STRING'],'导出');?></span>
	</p>
	<p class="operate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;操作: &nbsp;
		<span class="operate-button"><?php echo anchor("admin/counteract/manage/$status?airt=left_x&".$_SERVER['QUERY_STRING'],'左斜');?></span>&nbsp;
		<span class="operate-button"><?php echo anchor("admin/counteract/manage/$status?airt=right_x&".$_SERVER['QUERY_STRING'],'右斜');?></span>
	</p>
	<p class="search">
