                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="4"></th>
							<th colspan="7">天干</th>
							<th colspan="7">正相冲天干</th>
							<th colspan="7">次相冲天干</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->tiangan) && isset($rs->num1)) ? get_ganzhi_counteract($rs->tiangan, $rs->num1) : '';?></td>
							<td><?php echo (isset($rs->num1)) ? $rs->num1 : '';?></td>
							<td><?php echo (isset($rs->tiangan) && isset($rs->num2)) ? get_ganzhi_counteract($rs->tiangan, $rs->num2) : '';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td><?php echo (isset($rs->tiangan) && isset($rs->num3)) ? get_ganzhi_counteract($rs->tiangan, $rs->num3) : '';?></td>
							...
							<td><?php echo (isset($rs->num1) && isset($rs->xc_ganzhi_z_1)) ? get_ganzhi_counteract($rs->xc_ganzhi_z_1, $rs->num1) : '';?></td>
							<td><?php echo (isset($rs->num1)) ? $rs->num1 : '';?></td>
							<td><?php echo (isset($rs->num2) && isset($rs->xc_ganzhi_z_1)) ? get_ganzhi_counteract($rs->xc_ganzhi_z_1, $rs->num2) : '';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td><?php echo (isset($rs->num3) && isset($rs->xc_ganzhi_z_1)) ? get_ganzhi_counteract($rs->xc_ganzhi_z_1, $rs->num3) : '';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>

							<td><?php echo (isset($rs->xc_ganzhi_c_1) && isset($rs->xc_ganzhi_c_2)) ? $rs->xc_ganzhi_c_1.' ('.$rs->xc_ganzhi_c_2.')' : '';?></td>
							<td><?php echo (isset($rs->num1) && isset($rs->xc_ganzhi_c_1)) ? get_ganzhi_counteract($rs->xc_ganzhi_c_1, $rs->num1) : '';?></td>
							<td><?php echo (isset($rs->num1)) ? $rs->num1 : '';?></td>
							<td><?php echo (isset($rs->num2) && isset($rs->xc_ganzhi_c_1)) ? get_ganzhi_counteract($rs->xc_ganzhi_c_1, $rs->num2) : '';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td><?php echo (isset($rs->num3) && isset($rs->xc_ganzhi_c_1)) ? get_ganzhi_counteract($rs->xc_ganzhi_c_1, $rs->num3) : '';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
