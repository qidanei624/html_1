...
<div class="typecho-head-guid body-950">
	<dl id="typecho:guid">
		...
		<dd>
		<ul>
			<li<?php echo ($currentPage=='manage-threed')?' class="focus"':'';?>><?php echo anchor(site_url('admin/threed/manage/'),'3D',array('title'=>'3D'));?></li>
			<li<?php echo ($currentPage=='manage-threed')?' class="focus"':'';?>><?php echo anchor(site_url('admin/counteract/manage/'),'相生相克表',array('title'=>'相生相克表'));?></li>
			<li<?php echo ($currentPage=='manage-posts')?' class="focus"':'';?>><?php echo anchor(site_url('admin/counteract4/manage/'),'杀码',array('title'=>'杀码'));?></li>
