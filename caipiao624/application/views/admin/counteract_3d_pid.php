        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="17">总期号尾数-位置号码生克行轨迹对应和纯杂主题配搭轨迹对应</th>
                        </tr>
						<tr>
							<th>开奖日期</th>
							<th>年度期号</th>
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($rs->pid % 2 == 0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->pid) && isset($rs->num1)) ? get_prefix_nums($rs->pid, $rs->num1):'';?></td>
							<td><?php echo (isset($rs->num1)) ? $rs->num1 : '';?></td>
							<td><?php echo (isset($rs->pid) && isset($rs->num2)) ? get_prefix_nums($rs->pid, $rs->num2):'';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td><?php echo (isset($rs->pid) && isset($rs->num3)) ? get_prefix_nums($rs->pid, $rs->num3):'';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>

							<td><?php echo (isset($rs->pid)) ? $rs->pid : '';?></td>
							<td><?php echo (isset($rs->num1)) ? get_numeric_cz($rs->pid, $rs->num1):'';?></td>
							<td><?php echo (isset($rs->num1)) ? $rs->num1 : '';?></td>
							<td><?php echo (isset($rs->num2)) ? get_numeric_cz($rs->pid, $rs->num2):'';?></td>
							<td><?php echo (isset($rs->num2)) ? $rs->num2 : '';?></td>
							<td><?php echo (isset($rs->num3)) ? get_numeric_cz($rs->pid, $rs->num3):'';?></td>
							<td><?php echo (isset($rs->num3)) ? $rs->num3 : '';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
