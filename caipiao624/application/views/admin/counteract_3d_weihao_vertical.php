        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="11">位置号码-垂直生克行轨迹对应和纯杂主题配搭轨迹对应 (注意：左右斜不起作用)</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
							<th>年度期号</th>
							<th>纳音</th>
                            <th colspan="3">生克刑轨迹对应</th>
							<th></th>
                            <th colspan="3">纯杂主题配搭轨迹对应</th>
                        </tr>
                    </thead>
                    <tbody>
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><?php echo (isset($rs->arrow1)) ? $rs->arrow1 : '';?></td>
							<td><?php echo (isset($rs->arrow2)) ? $rs->arrow2 : '';?></td>
							<td><?php echo (isset($rs->arrow3)) ? $rs->arrow3 : '';?></td>

							<td></td>
							<td><?php echo (isset($rs->cz1)) ? $rs->cz1 : '';?></td>
							<td><?php echo (isset($rs->cz2)) ? $rs->cz2 : '';?></td>
							<td><?php echo (isset($rs->cz3)) ? $rs->cz3 : '';?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
                        <tr class="even">
