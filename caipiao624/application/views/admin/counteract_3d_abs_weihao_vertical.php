        ...
        <div class="container typecho-page-main">
            <div class="column-24 start-01 typecho-list">
                ...
                <table class="typecho-list-table">
                    ...
                    <thead>
                        <tr>
                            <th colspan="7">等距绝对值系统 - 位号垂直轨迹对应 (注意：左右斜不起作用)</th>
                        </tr>
						<tr>
							<th>总期号</th>
							<th>开奖日期</th>
							<th>年度期号</th>
							<th>纳音</th>
                            <th colspan="3">位号垂直轨迹对应</th>
                        </tr>
                    </thead>
                    <tbody>
						<?php if($threed->num_rows() > 0):?>
						<?php $num_rows = $threed->num_rows();?>
                        ...
                        <tr<?php echo ' class="even"'; ?> id="<?php echo 'threed-'.$rs->pid; ?>">
							...
							<td><?php echo (isset($rs->result_1)) ? $rs->result_1 : '';?></td>
							<td><?php echo (isset($rs->result_2)) ? $rs->result_2 : '';?></td>
							<td><?php echo (isset($rs->result_3)) ? $rs->result_3 : '';?></td>
                        </tr>
						<tr>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
							<td><?php echo ($key < $num_rows-1) ? '减' : '';?></td>
							<td><?php echo ($key < $num_rows-1) ? '减' : '';?></td>
							<td><?php echo ($key < $num_rows-1) ? '减' : '';?></td>
                        </tr>
                        <?php endforeach; ?>
