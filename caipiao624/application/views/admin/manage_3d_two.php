            ...
            <div class="column-24 start-01 typecho-list">
                ...
                <form method="get">
                    <p class="operate">操作: 
						...
						EXCEL:
						<span class="operate-button"><?php echo anchor('admin/threed/excel_write/3d_two?'.$_SERVER['QUERY_STRING'],'导出');?></span>
                    </p>
                    <p class="search">
                ...
                <table class="typecho-list-table">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($three->pid % 2==0)?'':' class="even"'; ?> id="<?php echo 'threed-'.$three->pid; ?>">
							...
							<?php $shuxing = get_shuxing($three->lottery_number);?>
							<td><?php echo $shuxing['sx'];?></td>
							<td><?php echo $shuxing['sum'];?></td>
							<td><?php echo (in_array(0, $shuxing['xu'])) ? 'ⓧ0' : '';?></td>
							<td><?php echo (in_array(1, $shuxing['xu'])) ? 'ⓧ1' : '';?></td>
							<td><?php echo (in_array(2, $shuxing['xu'])) ? 'ⓧ2' : '';?></td>
							<td><?php echo (in_array(3, $shuxing['xu'])) ? 'ⓧ3' : '';?></td>
							<td><?php echo (in_array(4, $shuxing['xu'])) ? 'ⓧ4' : '';?></td>
