...
class Counteract_mdl extends CI_Model
{
     ...
     */
	public function get_threed($limit = NULL,$offset = NULL,$order='ASC',$years_filter = 0,$col_filter='',$weishu_filter='',$nayins_filter=0,$zhutis_filter=0)
	{
		$sql = "SELECT  pid,
						DATE_FORMAT(FROM_UNIXTIME(created), '%Y-%m-%d') as created,
						lottery_qh,
						lottery_ganzhi,
						SUBSTRING(lottery_ganzhi,1,1) AS tiangan,
						SUBSTRING(lottery_ganzhi,2,1) AS dizhi,
						lunar,
						...
						xc_suishu,
						xc_nayin,
						SUBSTRING(xc_nayin,2,1) AS xc_nayin_z,
						SUBSTRING(xc_nayin,4,1) AS xc_nayin_c,
						xc_ganzhi,
						SUBSTRING(xc_ganzhi,2,1) AS xc_ganzhi_z_1,
						SUBSTRING(xc_ganzhi,3,1) AS xc_ganzhi_z_2,
						SUBSTRING(xc_ganzhi,5,1) AS xc_ganzhi_c_1,
						SUBSTRING(xc_ganzhi,6,1) AS xc_ganzhi_c_2,
						jgx,
						sx_year 
