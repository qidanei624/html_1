...
<script type="text/javascript" src="<?php echo base_url();?>javascript/swfupload/swfupload.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>javascript/swfupload/swfupload.queue.js"></script>
    ...
    (function () {
        ...
        window.addEvent('domready', function() {
            ...
            $(document).getElement('#upload-panel').addEvent('tabShow', function () {
                ...
                settings = {
                    flash_url : "<?php echo base_url();?>javascript/swfupload/swfupload.swf",
