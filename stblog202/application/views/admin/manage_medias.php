                ...
                <table class="typecho-list-table draggable">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($attachment->pid % 2==0)?'':' even'; ?> id="<?php echo 'attachment-'.$attachment->pid; ?>">
                            ...
                            <a class="right hidden-by-mouse" href="<?php echo site_url('posts/'.$attachment->parentPost->slug); ?>"><img src="<?php echo base_url();?>images/view.gif" title="<?php echo '浏览 '. $attachment->parentPost->title; ?>" width="16" height="16" alt="view" /></a>
                            <?php endif; ?>                            
                            </td>
