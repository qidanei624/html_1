                    ...
                    <table class="typecho-list-table draggable">
                        ...
                        <tbody>
                           ...
                           <tr<?php echo ($cate->mid % 2==0)?'':' class="even"'; ?> id="<?php echo 'category-'.$cate->mid; ?>">
                                ...
                                <td>
                                	<a class="right hidden-by-mouse" href="<?php echo site_url('category/'.$cate->slug); ?>"><img src="<?php echo base_url();?>images/view.gif" title="<?php echo '浏览 '. $cate->name; ?>" width="16" height="16" alt="view" /></a>
                                </td>
