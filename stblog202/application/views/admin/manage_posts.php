                ...
                <table class="typecho-list-table">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo ($post->pid % 2==0)?'':' class="even"'; ?> id="<?php echo 'post-'.$post->pid; ?>">
                            ...
                            <a class="right hidden-by-mouse" href="<?php echo site_url('posts/'.$post->slug); ?>"><img src="<?php echo base_url();?>images/view.gif" title="<?php echo '浏览 '. $post->title; ?>" width="16" height="16" alt="view" /></a>
                            <?php endif; ?>
                            </td>
