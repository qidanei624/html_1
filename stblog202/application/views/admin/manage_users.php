                ...
                <table class="typecho-list-table">
                    ...
                    <tbody>
                    	...
                    	<tr<?php echo ($user->uid % 2==0)?'':' class="even"'; ?> id="<?php echo 'user-'.$user->uid; ?>">
                            ...
                            <td>
                            <a class="right hidden-by-mouse" href="<?php echo site_url('author/'.$user->uid); ?>"><img src="<?php echo base_url();?>images/view.gif" title="<?php echo '浏览 '. $user->screenName; ?>" width="16" height="16" alt="view" /></a>
                            </td>
